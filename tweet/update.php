...
if (mysql_connect('fdb2.biz.nf','1470566_post','rootpass') && mysql_select_db('1470566_post')){
    ...
    $guestbook_name = mysql_real_escape_string(htmlentities($_POST['name']));
    $guestbook_email = mysql_real_escape_string(htmlentities($_POST['email']));
    $guestbook_message = mysql_real_escape_string(htmlentities($_POST['message']));
